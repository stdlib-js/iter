...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/iter@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/iter@umd/bundle.js"></script>
```
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert/contains@umd/bundle.js"></script>
