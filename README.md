...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/iter@v0.3.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/iter/actions/workflows/test.yml/badge.svg?branch=v0.3.2
[test-url]: https://github.com/stdlib-js/iter/actions/workflows/test.yml?query=branch:v0.3.2
